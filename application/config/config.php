 ...
 */
$config['composer_autoload'] = dirname(FCPATH) . '/vendor/audoload.php';
...
/*
  ...
  |
 */
$config['log_path'] = getenv('CI_LOG_PATH') ? getenv('CI_LOG_PATH') : '';
...
/*
  ...
  |
 */
$config['cache_path'] = getenv('CI_CACHE_PATH') ? getenv('CI_CACHE_PATH') : '';
